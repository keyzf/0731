...
module.exports = React.createClass({
  ...
  _getFilterData: function () {
    ...
    return [{
      type: 'input', name: 'name1', label: '名称1',defaultValue:this.state.filterData.v1
    }, {
      type: 'input', name: 'name2', label: '名称2',defaultValue:this.state.filterData.v2
    }, {
      type: 'input', name: 'name3', label: '很长很长的名称怎么办',defaultValue:this.state.filterData.v3
    }, {
      type: 'select', name: 'select1', label: '下拉框2', options: options, searchable: true, multiselect: true,defaultValue:this.state.filterData.v4
    }, {
      type: 'datePicker', name: 'date1', label: '时间1',defaultValue:this.state.filterData.v5
    }, {
      type: 'input', name: 'name4', label: '名称4',defaultValue:this.state.filterData.v6
    }, {
      type: 'input', name: 'name6', label: '很长很长的名称怎么办',defaultValue:this.state.filterData.v7
    }, {
