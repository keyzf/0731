module.exports = {
    ...
    //strType 字符串类型
    getNextDay:function(date,type,strType){
    ...
    //type:0时间类型，1时间戳，2字符串
    //strType 字符串类型
    getTheFirstDayOfMonth:function(date,type,strType){
        if(!(date instanceof Date)){
            return date||'';
        }
        var returnType = type||0,
    ...
    //type:0时间类型，1时间戳，2字符串
    //strType 字符串类型
    getTheLastDayOfMonth:function(date,type,strType){
        if(!(date instanceof Date)){
            return date||'';
        }
        var returnType = type||0,
    ...
    //type:0时间类型，1时间戳，2字符串
    //strType 字符串类型
    getTheDayOfNextYear:function(date,type,strType){
        var returnType = type||0,
            dateStrType = strType||0,
    ...
    //type:0时间类型，1时间戳，2字符串
    //strType 字符串类型
    getTheNextDayOfNextYear:function(date,type,strType){
        if(!(date instanceof Date)){
            return date||'';
        }
        var returnType = type||0,
