...
var PullDownTree = React.createClass({
    ...
    _getArrListData: function (treeData) {
        var self = this,
            arrListData = [],
            selectItems = [],
            selectIds = [];
        Utils.CommonUtil.traverseTreeData(treeData, {
            childrenKey: this.props.childrenKey, callFn: function (node, parentNode) {
                var item = {};
                for (var key in node) {
    ...
    _onChange: function (selected, selectItems) {
        this.setState({
        ...
        return (
            <div
                ...
                <ul
                    ...
                    {
                        choices.concat(
                            <li key={self.state.selectItems.length} className='select2-search-field'>
                                <input
                                    ref='selectInput'
                                    type='text'
                ...
                <div className='select2-drop select2-drop-active' ref='drop' style={dropStyle}>
