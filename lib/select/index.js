...
var Select = React.createClass({
    ...
    _handleMultiAutoInputClick: function _handleMultiAutoInputClick(e) {
    ...
    _handleInputPaste: function _handleInputPaste(e) {
        /*
              e.preventDefault();
    ...
    render: function render() {
        ...
        var className = classnames({
            ...
            'select': true,
            'select2-empty': this.props.multiselect ? this.state.multiselectArray.length === 0 : !this.state.selectedOption,
            'select2-dropdown-open': this.state.open,
            'select2-allowclear': this.props.clearable && this.state.selectedOption && !this.props.disabled,
