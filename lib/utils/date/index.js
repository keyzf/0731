...
module.exports = {
    ...
    getTheFirstDayOfMonth: function getTheFirstDayOfMonth(date) {
        if (!(date instanceof Date)) {
            return date || '';
        }
    ...
    getTheLastDayOfMonth: function getTheLastDayOfMonth(date) {
        if (!(date instanceof Date)) {
            return date || '';
        }
    ...
    getTheDayOfNextYearStr: function getTheDayOfNextYearStr(date) {
        var dateUnix = date * 1,
            newUnix = dateUnix + 31536000000;
        return this.dateUnixToStr(newUnix, 0);
    },

    getTheNextDayOfNextYearStr: function getTheNextDayOfNextYearStr(date) {
        if (!(date instanceof Date)) {
            return date || '';
        }
        var dateUnix = date * 1,
