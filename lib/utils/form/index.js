...
module.exports = {
  ...
  getPasswordRank: function getPasswordRank(value) {
    var n = 0;
    return value.match(/[a-z]/g) && n++, value.match(/[A-Z]/g) && n++, value.match(/[0-9]/g) && n++, value.match(/[^a-zA-Z0-9]/g) && n++, n = n > 3 ? 3 : n, (value.length < 6 || /^\d{1,8}$/.test(value)) && (n = 0), value.length < 8 && n > 1 && (n = 1), n;
  }
};