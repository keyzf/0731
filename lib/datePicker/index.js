  ...
  render: function render() {
    ...
    return React.createElement(
      ...
      React.createElement(
        ...
        this.props.showClose && this.state.startValue && !this.showCalendar && this.state.mouseOver ? React.createElement(
          'div',
          { style: { position: 'absolute', right: 30, top: 9, cursor: 'pointer', fontSize: 12 } },
