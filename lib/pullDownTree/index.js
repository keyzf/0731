...
var PullDownTree = React.createClass({
    ...
    _createOnChoice: function _createOnChoice(item) {
        var self = this,
            ...
            Utils.CommonUtil.traverseTreeData(self.state.treeData, {
                childrenKey: self.props.childrenKey, callFn: function callFn(node, parentNode) {
        ...
        return React.createElement(
            'li',
            { key: Utils.CommonUtil.getRandomId(), className: 'select2-search-choice' },
            React.createElement(
                'div',
                null,
