  ...
  _packRender: function _packRender() {
    ...
    if (this.isIE) {
      ...
      render = React.createElement(
        ...
        React.createElement(
          'div',
          { onClick: this.commonChooseFile, style: { overflow: 'hidden', postion: 'relative', display: this.wrapperDisplay } },
          this.state.chooseBtn
        ),
        this.state.middle,
        React.createElement(
          'div',
          { onClick: this.commonUpload, style: { overflow: 'hidden', postion: 'relative', display: this.chooseAndUpload ? 'none' : this.wrapperDisplay } },
    ...
    function _insertIEForm(formArr, i) {
      ...
      formArr.push(React.createElement(
        ...
        React.createElement(
          ...
          this.state.uploadBtn,
          React.createElement('input', { type: 'submit', style: { position: 'absolute', left: 0, top: 0, fontSize: '50px', width: '200px', opacity: 0 } })
        ),
        this.state.after
      ));
