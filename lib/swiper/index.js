...
var ReactIDangerousSwiper = React.createClass({
  ...
  propTypes: {
    ...
    customButton: React.PropTypes.bool,
  ...
  _renderNextButton: function _renderNextButton() {
    if (!this.props.nextButton || this.props.customButton) return false;
    return React.createElement('div', { className: this.props.nextButton.replace(/\./g, '') });
  },

  _renderPrevButton: function _renderPrevButton() {
    if (!this.props.prevButton || this.props.customButton) return false;
  ...
  render: function render() {
    ...
    return React.createElement('div', { className: this.props.slideClassContainer }, React.createElement('div', { className: 'swiper-wrapper' }, React.Children.map(this.props.children, function (e) {
      return React.cloneElement(e, { className: [slideClass, e.props.className, noSwipingClass].join(' ') });
    })), React.createElement('div', { className: 'swiper-pagination' }), this._renderScrollBar(), this._renderNextButton(), this._renderPrevButton());
  }
});

module.exports = ReactIDangerousSwiper;